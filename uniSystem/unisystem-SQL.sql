...
CREATE TABLE BOARD_FILE (
    BOARD_FILE_NO NUMBER PRIMARY KEY NOT NULL,
...
COMMENT ON COLUMN BOARD_FILE.BOARD_FILE_PATH IS '파일 경로';
COMMENT ON COLUMN BOARD_FILE.BOARD_FILE_ORIGINAL IS '원본 파일명';
COMMENT ON COLUMN BOARD_FILE.BOARD_FILE_RENAME IS '변경된 파일명';
COMMENT ON COLUMN BOARD_FILE.BOARD_FILE_CATEGORY_NO IS '파일 카테고리 번호';
COMMENT ON COLUMN BOARD_FILE.BOARD_NO IS '게시글 번호';
