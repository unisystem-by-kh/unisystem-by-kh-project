...
public class BoardTypeInterceptor implements HandlerInterceptor{
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
		...
		if(application.getAttribute("categoryType") == null) {
			
			// 조회 서비스 호출
			System.out.println("BOARD_TYPE 조회 서비스 호출");
			
			List<Map<String, Object>> categoryType = service.selectCategory();
			System.out.println(categoryType);
			// application scope에 세팅
			application.setAttribute("categoryType", categoryType);
		}
